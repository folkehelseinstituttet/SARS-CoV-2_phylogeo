...
#   ____________________________________________________________________________
#   Read required data                                                      ####
metadat = fread(paste0(path_Main,"nextstrain_groups_niph_ncov_UK-centric-2021-05-31_metadata.tsv"))
metadata = metadat
tree = read.tree(paste0(path_Main,"nextstrain_groups_niph_ncov_UK-centric-2021-05-31_timetree.nwk"))
...
nodelabels(cex=0.5)
tree = extract.clade(tree, node=6011)
...
transition_matrix = rbind(c(-0.1202222, 0.1202222),c(1.2022219, -1.2022219)) #Write up from the print above
