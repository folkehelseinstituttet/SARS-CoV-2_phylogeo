...
metadat = fread(paste0(path_Main,"nextstrain_groups_niph_ncov_UK-centric-2021-06-28_metadata_NN.tsv"))
metadata = metadat
tree = read.tree(paste0(path_Main,"nextstrain_groups_niph_ncov_UK-centric-2021-06-28_timetree_NN.nwk"))
...
nodelabels(cex=0.5)
tree = extract.clade(tree, node=5931)
...
transition_matrix = rbind(c(-0.1159497, 0.1159497),c(1.1594966, -1.1594966))
