...
path_Results = "~/Dropbox/Covid/UK_03_24/Results/"  #Replace these paths to run locally.
path_Rscripts = "~/Dropbox/Covid/Rfunctions/"  #Replace these paths to run locally.
path_Data =  "~/Dropbox/Covid/UK_03_24/Data/"

tree = read.tree(paste0(path_Main,"nextstrain_groups_niph_ncov_UK-centric-2021-04-07_timetree.nwk"))
...
library(data.table)
library(lubridate)
metadat = fread(paste0(path_Main,"nextstrain_groups_niph_ncov_UK-centric-2021-04-07_metadata.tsv"))
...
source(paste0(path_Rscripts, "Import_export_ace_output.R"))
library(pbapply)
#multi_counts = pbreplicate(100, count_import_export_ace_uncertainty(tree, ace_nodes = castor$ancestral_likelihoods, give_tips = Norwegian_tips,ace_tips = to.matrix(Locations,seq=c("Norway","RoW")),start_time = start_date))
#save(multi_counts, file="paste0(path_to_Data,"count_ML_UK_100.Rdata"))
...
```{r,include=F}
library(data.table)
metadata = fread(paste0(path_Main,"nextstrain_groups_niph_ncov_UK-centric-2021-04-07_metadata.tsv"))
#Debug:
...
source(paste0(path_Rscripts, "Relative_load_multi.R"))
