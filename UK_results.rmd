...
#   ____________________________________________________________________________
#   Read required data                                                      ####
metadat = fread(paste0(path_Main,"nextstrain_groups_niph_ncov_UK-centric-2021-05-25_metadata.tsv"))
metadata = metadat
tree = read.tree(paste0(path_Main,"nextstrain_groups_niph_ncov_UK-centric-2021-05-25_timetree.nwk"))
...
nodelabels(cex=0.5)
tree = extract.clade(tree, node=5789)
...
transition_matrix = rbind(c(-0.1370393, 0.1370393),c(1.3703926, -1.3703926)) #Write up from the print above
