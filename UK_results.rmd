...
metadat = fread(paste0(path_Main,"nextstrain_groups_niph_ncov_UK-centric-2021-07-13_metadata_NN.tsv"))
metadata = metadat
tree = read.tree(paste0(path_Main,"nextstrain_groups_niph_ncov_UK-centric-2021-07-13_timetree_NN.nwk"))
...
nodelabels(cex=0.5)
tree = extract.clade(tree, node=5959)
...
transition_matrix = rbind(c(-0.09335977, 0.09335977),c(0.93359768, -0.93359768))
