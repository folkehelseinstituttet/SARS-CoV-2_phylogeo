...
nodelabels(cex=0.5)
tree = extract.clade(tree, node=6772)
...
transition_matrix = rbind(c(-0.07326712, 0.07326712),c(0.73267120, -0.73267120)) #Write up from the print above
# #OLD WAS transition_matrix = rbind(c(-0.07228033 ,0.07228033),c(0.72280328,-0.72280328)) #Write up from the print above
