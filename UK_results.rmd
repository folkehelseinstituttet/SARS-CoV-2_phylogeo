...
#   ____________________________________________________________________________
#   Read required data                                                      ####
metadat = fread(paste0(path_Main,"nextstrain_groups_niph_ncov_UK-centric-2021-05-10_metadata.tsv"))
metadata = metadat
tree = read.tree(paste0(path_Main,"nextstrain_groups_niph_ncov_UK-centric-2021-05-10_timetree.nwk"))
...
nodelabels(cex=0.5)
tree = extract.clade(tree, node=5758)
...
transition_matrix = rbind(c(-0.1388084, 0.1388084),c(1.3880840, -1.3880840)) #Write up from the print above
