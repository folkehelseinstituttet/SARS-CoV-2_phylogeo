...
metadat = fread(paste0(path_Main,"nextstrain_groups_niph_ncov_UK-centric-2021-06-14_metadata_NN.tsv"))
metadata = metadat
tree = read.tree(paste0(path_Main,"nextstrain_groups_niph_ncov_UK-centric-2021-06-14_timetree_NN.nwk"))
...
nodelabels(cex=0.5)
tree = extract.clade(tree, node=5827)
...
transition_matrix = rbind(c(-0.124796, 0.124796),c(1.247960, -1.247960))
