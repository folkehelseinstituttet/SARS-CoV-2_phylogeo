...
#   ____________________________________________________________________________
#   Read required data                                                      ####
metadat = fread(paste0(path_Main,"nextstrain_groups_niph_ncov_UK-centric-2021-04-29_metadata.tsv"))
metadata = metadat
tree = read.tree(paste0(path_Main,"nextstrain_groups_niph_ncov_UK-centric-2021-04-29_timetree.nwk"))
...
nodelabels(cex=0.5)
tree = extract.clade(tree, node=4464)
...
transition_matrix = rbind(c(-0.1353298, 0.1353298),c(1.3532984, -1.3532984)) #Write up from the print above
...
## Old Estimate from 2021-04-20: transition_matrix = rbind(c(-0.07228033 ,0.07228033),c(0.72280328,-0.72280328)) #Write up from the print above
