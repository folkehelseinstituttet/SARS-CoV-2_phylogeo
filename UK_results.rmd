...
#   ____________________________________________________________________________
#   Read required data                                                      ####
metadat = fread(paste0(path_Main,"nextstrain_groups_niph_ncov_UK-centric-2021-05-03_metadata.tsv"))
metadata = metadat
tree = read.tree(paste0(path_Main,"nextstrain_groups_niph_ncov_UK-centric-2021-05-03_timetree.nwk"))
...
nodelabels(cex=0.5)
tree = extract.clade(tree, node=4530)
...
transition_matrix = rbind(c(-0.1319801, 0.1319801),c(1.3198013, -1.3198013)) #Write up from the print above
