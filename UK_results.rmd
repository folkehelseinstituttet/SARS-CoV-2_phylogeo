...
#   ____________________________________________________________________________
#   Read required data                                                      ####
metadat = fread(paste0(path_Main,"nextstrain_groups_niph_ncov_UK-centric-2021-05-18_metadata.tsv"))
metadata = metadat
tree = read.tree(paste0(path_Main,"nextstrain_groups_niph_ncov_UK-centric-2021-05-18_timetree.nwk"))
...
nodelabels(cex=0.5)
tree = extract.clade(tree, node=5737)
...
transition_matrix = rbind(c(-0.1436812, 0.1436812),c(1.4368116, -1.4368116)) #Write up from the print above
