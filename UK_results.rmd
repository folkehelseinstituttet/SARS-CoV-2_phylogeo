...
metadat = fread(paste0(path_Main,"nextstrain__metadata_Alpha_2021-08-02.tsv"))
metadata = metadat
tree = read.tree(paste0(path_Main,"nextstrain__timetree_Alpha_2021-08-02.nwk"))
...
nodelabels(cex=0.5)
tree = extract.clade(tree, node=6027)
...
transition_matrix = rbind(c(-0.1032237, 0.1032237),c(1.0322375, -1.0322375))
