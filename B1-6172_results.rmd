...
metadat = fread(paste0(path_Main,"nextstrain_groups_niph_ncov_delta-2021-08-16_metadata_NN.tsv"))
metadata = metadat #Used alternate spellings some places.
tree = read.tree(paste0(path_Main,"nextstrain_groups_niph_ncov_delta-2021-08-16_timetree_NN.nwk"))
...
tree = extract.clade(tree, node=4495)
...
g1 = ggplot(dat, aes(x=dates,y=i50))+geom_line(col="Red")+theme_minimal(base_size=20)+
  ...
  scale_x_date(date_breaks="1 week",limits =c(as.Date("2021-04-01"), as.Date("2021-08-09")),expand=c(0,0))+
  ylab("Import")+
...
g2 = ggplot(dat, aes(x=dates,y=e50))+geom_line(col="Darkgreen")+theme_minimal(base_size=20)+ylim(0,300)+
  scale_x_date(date_breaks="1 week",limits =c(as.Date("2021-04-01"), as.Date("2021-08-08")), expand=c(0,0))+
...
write.table(mrca_sizes, file=("/home/vehuardo/Documents/rstudio_nextstrainmodelling/SARS-CoV-2_phylogeo/Delta_lineage_sizes.txt"))
write.csv(mrca_sizes, file=("/home/vehuardo/Dropbox/Covid/Alpha_vs_Delta/Delta_lineage_sizes.csv"))
