...
metadat = fread(paste0(path_Main,"nextstrain_groups_niph_ncov_delta-2021-08-08_metadata_NN.tsv"))
metadata = metadat #Used alternate spellings some places.
tree = read.tree(paste0(path_Main,"nextstrain_groups_niph_ncov_delta-2021-08-08_timetree_NN.nwk"))
...
tree = extract.clade(tree, node=3573)
...
write.table(mrca_sizes, file=("~/Dropbox/Covid/B1-617-2/MRCA_lineageSize_2021-08-16.txt"))
