...
metadat = fread(paste0(path_Main,"nextstrain__metadata_Delta_2021-08-02.tsv"))
metadata = metadat #Used alternate spellings some places.
tree = read.tree(paste0(path_Main,"nextstrain__timetree_Delta_2021-08-02.nwk"))
...
tree = extract.clade(tree, node=2523)
...
g1 = ggplot(dat, aes(x=dates,y=i50))+geom_line(col="Red")+theme_minimal(base_size=20)+
  ...
  scale_x_date(date_breaks="1 week",limits =c(as.Date("2021-04-01"), as.Date("2021-08-01")),expand=c(0,0))+
  ylab("Import")+
...
g2 = ggplot(dat, aes(x=dates,y=e50))+geom_line(col="Darkgreen")+theme_minimal(base_size=20)+ylim(0,100)+
  scale_x_date(date_breaks="1 week",limits =c(as.Date("2021-04-01"), as.Date("2021-08-01")), expand=c(0,0))+
...
write.table(mrca_sizes, file=("~/Dropbox/Covid/B1-617-2/MRCA_lineageSize_2021-08-02.txt"))
