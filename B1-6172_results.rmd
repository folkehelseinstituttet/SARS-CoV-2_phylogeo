...
metadat = fread(paste0(path_Main,"nextstrain_groups_niph_ncov_B-1-617-2021-06-21_metadata_NN.tsv"))
metadata = metadat #Used alternate spellings some places.
tree = read.tree(paste0(path_Main,"nextstrain_groups_niph_ncov_B-1-617-2021-06-21_timetree_NN.nwk"))
...
tree = extract.clade(tree, node=1391)
