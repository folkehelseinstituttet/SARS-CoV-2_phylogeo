...
#   ____________________________________________________________________________
#   Read required data                                                      ####
metadat = fread(paste0(path_Main,"nextstrain_groups_niph_ncov_B-1-617-2021-05-31_metadata.tsv"))
metadata = metadat #Used alternate spellings some places.
tree = read.tree(paste0(path_Main,"nextstrain_groups_niph_ncov_B-1-617-2021-05-31_timetree.nwk"))
...
tree = extract.clade(tree, node=959)
...
# if the above fails, set transition matrix by other means e.g. by using entire B.1.617 and follow below steps
transition_matrix = rbind(c(-0.01243657, 0.01243657),c(0.20321063, -0.20321063))
...
g1 = ggplot(dat, aes(x=dates,y=i50))+geom_line(col="Red")+theme_minimal(base_size=20)+
  ...
  scale_x_date(date_breaks="1 week",limits =c(as.Date("2021-04-01"), as.Date("2021-05-31")),expand=c(0,0))+
  ylab("Import")+
