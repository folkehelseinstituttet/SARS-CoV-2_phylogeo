...
#   ____________________________________________________________________________
#   Read required data                                                      ####
metadat = fread(paste0(path_Main,"nextstrain_groups_niph_ncov_B-1-617-2021-06-08_metadata.tsv"))
metadata = metadat #Used alternate spellings some places.
tree = read.tree(paste0(path_Main,"nextstrain_groups_niph_ncov_B-1-617-2021-06-08_timetree.nwk"))
...
#tree = extract.clade(tree, node=763) Correct node for entire B.1.617
tree = extract.clade(tree, node=1023)
...
#Transmission matrix from 05-31: transition_matrix = rbind(c(-0.01243657, 0.01243657),c(0.20321063, -0.20321063))
# estimated from entire tree 2021-06-08 : transition_matrix = rbind(c(-0.01869981, 0.01869981),c(0.22033859, -0.22033859))
transition_matrix = rbind(c(-0.002040845, 0.002040845),c(0.245732068, -0.245732068))

#Looping back here, pruning the tree again to only include B.1.617.2, but using the above transition matrix
...
write.table(mrca_sizes, file=("~/Dropbox/Covid/B1-617-2/MRCA_lineageSize_2021-06-08.txt"))
