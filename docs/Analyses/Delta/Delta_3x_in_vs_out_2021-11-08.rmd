...
metadat = fread(paste0(path_Main,"nextstrain_groups_niph_ncov_delta-importanalysis-2021-11-08_metadata.tsv"))
metadata = metadat #Used alternate spellings some places.
tree = read.tree(paste0(path_Main,"nextstrain_groups_niph_ncov_delta-importanalysis-2021-11-08_timetree.nwk"))
...
nodelabels(cex=0.5)
tree = extract.clade(tree, node=3527)
...
transition_matrix = rbind(c(-0.679972, 0.679972),c(2.039916, -2.039916))
