---
title: "SARS-CoV-2 Omicron variant: All samples 3xRate in/out Norway"
author: ""
date: "14/12/2021"
output: 
  github_document
...
The analyses take a dated phylogeny exported from NextStrain as a starting point for quantifying imports and local transmission of Sars-CoV-2 Omicron variant in Norway. 
...
metadat = fread(paste0(path_Main,"nextstrain_groups_niph_ncov_omicron-2021-12-13_metadata.tsv"))
metadata = metadat #Used alternate spellings some places.
tree = read.tree(paste0(path_Main,"nextstrain_groups_niph_ncov_omicron-2021-12-13_timetree.nwk"))
...
nodelabels(cex=0.5)
tree = extract.clade(tree, node=953)
...
transition_matrix = rbind(c(-0.1779566 , 0.1779566 ),c(0.5338699, -0.5338699))
...
#save(multi_counts, file=paste0(path_Data,"count_ML_Omicron_3xRate_100.Rdata"))
load(paste0(path_Data,"count_ML_Omicron_3xRate_100.Rdata"))
...
#save(Result,file=paste0(path_Data,"count_once_Omicron_3xRate.Rdata"))
load(paste0(path_Data,"count_once_Omicron_3xRate.Rdata"))
```
...
g2 = ggplot(dat, aes(x=dates,y=e50))+geom_line(col="Darkgreen")+theme_minimal(base_size=20)+ylim(0,20)+
  scale_x_date(date_breaks="1 week",limits =c(as.Date("2021-03-15"),as.Date(dat$dates[length(dat$dates)])), expand=c(0,0))+
...
write.table(mrca_sizes, file=("/home/vehuardo/Documents/rstudio_nextstrainmodelling/SARS-CoV-2_phylogeo/Omicron_lineage_sizes_3xRates.txt"))
write.csv(mrca_sizes, file=("/home/vehuardo/Dropbox/Covid/Omicron/Omicron_lineage_sizes_3xRates.csv"))
