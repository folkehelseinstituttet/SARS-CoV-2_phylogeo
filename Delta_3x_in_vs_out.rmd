...
metadat = fread(paste0(path_Main,"nextstrain_groups_niph_ncov_delta-2021-09-20_metadata.tsv"))
metadata = metadat #Used alternate spellings some places.
tree = read.tree(paste0(path_Main,"nextstrain_groups_niph_ncov_delta-2021-09-20_timetree.nwk"))
...
nodelabels(cex=0.5)
tree = extract.clade(tree, node=6579)
...
transition_matrix = rbind(c(-0.4352623, 0.4352623),c(1.3057868, -1.3057868)) 
...
g1 = ggplot(dat, aes(x=dates,y=i50))+geom_line(col="Red")+theme_minimal(base_size=20)+
  ...
  scale_x_date(date_breaks="1 week",limits =c(as.Date("2021-02-15"), as.Date(dat$dates[length(dat$dates)])),expand=c(0,0))+
  ylab("Import")+
