...
metadat = fread(paste0(path_Main,"nextstrain_groups_niph_ncov_delta-2021-08-23_metadata_NN.tsv"))
metadata = metadat #Used alternate spellings some places.
tree = read.tree(paste0(path_Main,"nextstrain_groups_niph_ncov_delta-2021-08-23_timetree_NN.nwk"))
...
nodelabels(cex=0.5)
tree = extract.clade(tree, node=5105)
...
transition_matrix = rbind(c(-0.6492185, 0.6492185),c(1.9476555, -1.9476555)) 
## 2021-08-23 Transition matrix using using 10x rate: = rbind(c(-0.1882434, 0.1882434),c(1.8824343, -1.8824343)) ## 2021-08-23 Transition matrix using using 5x rate: = rbind(c(-0.3815287, 0.3815287),c(1.9076433, -1.9076433)) 
