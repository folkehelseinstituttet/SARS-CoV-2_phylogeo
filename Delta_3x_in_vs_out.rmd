...
metadat = fread(paste0(path_Main,"nextstrain_groups_niph_ncov_delta-2021-09-06_metadata_NN.tsv"))
metadata = metadat #Used alternate spellings some places.
tree = read.tree(paste0(path_Main,"nextstrain_groups_niph_ncov_delta-2021-09-06_timetree_NN.nwk"))
...
nodelabels(cex=0.5)
tree = extract.clade(tree, node=5370)
...
transition_matrix = rbind(c(-0.413421, 0.413421),c(1.240263, -1.240263)) 
...
g2 = ggplot(dat, aes(x=dates,y=e50))+geom_line(col="Darkgreen")+theme_minimal(base_size=20)+ylim(0,300)+
  scale_x_date(date_breaks="1 week",limits =c(as.Date("2020-11-30"),as.Date(dat$dates[length(dat$dates)])), expand=c(0,0))+
