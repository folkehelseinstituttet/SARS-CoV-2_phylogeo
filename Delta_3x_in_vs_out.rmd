...
metadat = fread(paste0(path_Main,"nextstrain_groups_niph_ncov_delta-importanalysis-2021-10-18_metadata.tsv"))
metadata = metadat #Used alternate spellings some places.
tree = read.tree(paste0(path_Main,"nextstrain_groups_niph_ncov_delta-importanalysis-2021-10-18_timetree.nwk"))
...
nodelabels(cex=0.5)
tree = extract.clade(tree, node=2890)
...
transition_matrix = rbind(c(-0.6053547, 0.6053547),c(1.8160641, -1.8160641))
## SUBSEQUENT BUILDS WERE BALANCED IN TERMS OF TEMPORAL SAMPLING ###
