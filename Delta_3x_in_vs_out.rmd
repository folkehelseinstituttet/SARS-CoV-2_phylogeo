...
metadat = fread(paste0(path_Main,"nextstrain_groups_niph_ncov_delta-2021-10-11_metadata.tsv"))
metadata = metadat #Used alternate spellings some places.
tree = read.tree(paste0(path_Main,"nextstrain_groups_niph_ncov_delta-2021-10-11_timetree.nwk"))
...
nodelabels(cex=0.5)
tree = extract.clade(tree, node=8515)
...
transition_matrix = rbind(c(-0.263285, 0.263285),c(0.7900130, -0.7900130)) 
...
g2 = ggplot(dat, aes(x=dates,y=e50))+geom_line(col="Darkgreen")+theme_minimal(base_size=20)+ylim(0,1000)+
  scale_x_date(date_breaks="1 week",limits =c(as.Date("2021-03-15"),as.Date(dat$dates[length(dat$dates)])), expand=c(0,0))+
