...
#LineageHomology::FitTransitionFreeX(tree,Locations,model=c(rbind(c(0,1,1,0))), scaling_factor = 5) #The 5X rate is added internally
## Update below matrix with new estimates from Lineage Homology
transition_matrix = rbind(c(-0.1925283, 0.1925283),c(0.9626328, -0.9626328)) 
## 2021-08-23 Transition matrix using using 10x rate: = rbind(c(-0.1882434, 0.1882434),c(1.8824343, -1.8824343)) ## 2021-08-23 Transition matrix using using 3x rate: = rbind(c(-0.6492185, 0.6492185),c(1.9476555, -1.9476555)) 
...
#save(multi_counts, file=paste0(path_Data,"count_ML_Delta_100.Rdata"))
load(paste0(path_Data,"count_ML_Delta_100.Rdata"))
...
#save(Result,file=paste0(path_Data,"count_once_Delta.Rdata"))
load(paste0(path_Data,"count_once_Delta.Rdata"))
```
...
#save(Result_with_uncertainty,file=paste0(path_Data,"Relative_load_100_5xRate.Rdata")) 
load(paste0(path_Data,"Relative_load_100_5xRate.Rdata"))
...
write.table(mrca_sizes, file=("/home/vehuardo/Documents/rstudio_nextstrainmodelling/SARS-CoV-2_phylogeo/Delta_lineage_sizes_5xFixedRateIn.txt"))
write.csv(mrca_sizes, file=("/home/vehuardo/Dropbox/Covid/Alpha_vs_Delta/Delta_lineage_sizes_5xFixedRateIn.csv"))
