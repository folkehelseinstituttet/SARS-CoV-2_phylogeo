...
metadat = fread(paste0(path_Main,"nextstrain_groups_niph_ncov_delta-importanalysis-2021-12-13_metadata.tsv"))
metadata = metadat #Used alternate spellings some places.
tree = read.tree(paste0(path_Main,"nextstrain_groups_niph_ncov_delta-importanalysis-2021-12-13_timetree.nwk"))
...
nodelabels(cex=0.5)
tree = extract.clade(tree, node=4254)
...
transition_matrix = rbind(c(-1.763243, 1.763243),c(1.763243, -1.763243))
