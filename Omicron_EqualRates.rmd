...
metadat = fread(paste0(path_Main,"nextstrain_groups_niph_ncov_omicron-2021-12-20_metadata.tsv"))
metadata = metadat #Used alternate spellings some places.
tree = read.tree(paste0(path_Main,"nextstrain_groups_niph_ncov_omicron-2021-12-20_timetree.nwk"))
#   ____________________________________________________________________________
...
nodelabels(cex=0.5)
tree = extract.clade(tree, node=2033)
...
transition_matrix = rbind(c(-0.6057073 , 0.6057073 ),c(0.6057073, -0.6057073))
# transmission matrix from 2021-12-13: transition_matrix = rbind(c(-0.5396541 , 0.5396541 ),c(0.5396541, -0.5396541))
