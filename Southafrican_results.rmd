...
legend("bottomleft",c("Norway", "RoW"), col = c("#E41A1C","#377EB8"),pch=20, cex = 5, pt.cex=5, bty="n")
# 
```
...
```{r,include=F}
library(data.table)
metadata = fread(paste0(path_Main,"nextstrain_groups_niph_ncov_southafrican-2021-04-07_metadata.tsv"))
#Debug:
