...
path_Results = "~/Dropbox/Covid/Southafrican_03_24/Results/"  #Replace these paths to run locally.
...
#Reconstruct ancestral states using maximum likelihood with a fixed transition matrix. 
